...
**This repo is based on the original Mochalog repository [here](https://github.com/mochalog/mochalog). It is a Maven-based (rather than Gradel) and much simplified and documented version.**
